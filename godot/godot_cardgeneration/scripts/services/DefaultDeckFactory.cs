...
public static class DefaultDeckFactory
{
    ...
    private static void AddMonsters(List<CardResource> cards, IReadOnlyDictionary<ElementType, ElementResource> elements, IReadOnlyDictionary<string, CardResource>? existingCards)
    {
        ...
        cards.Add(UseExisting(existingCards, "monster_neutral_1_c", () => Monster(elements, "monster_neutral_1_c", ElementType.Neutral, 1, [(ElementType.Neutral, 1)], 1, [(ElementType.Neutral, 2)])));
        ...
        cards.Add(UseExisting(existingCards, "monster_neutral_2_c", () => Monster(elements, "monster_neutral_2_c", ElementType.Neutral, 2, [(ElementType.Neutral, 3)], 2, [(ElementType.Neutral, 4)])));
        ...
        cards.Add(UseExisting(existingCards, "monster_grass_2_c", () => Monster(elements, "monster_grass_2_c", ElementType.Grass, 2, [(ElementType.Neutral, 2), (ElementType.Grass, 2)], 2, [(ElementType.Grass, 3)])));
        ...
        cards.Add(UseExisting(existingCards, "monster_flame_2_c", () => Monster(elements, "monster_flame_2_c", ElementType.Flame, 2, [(ElementType.Neutral, 2), (ElementType.Flame, 2)], 2, [(ElementType.Flame, 3)])));
        ...
        cards.Add(UseExisting(existingCards, "monster_water_2_c", () => Monster(elements, "monster_water_2_c", ElementType.Water, 2, [(ElementType.Neutral, 2), (ElementType.Water, 2)], 2, [(ElementType.Water, 3)])));
