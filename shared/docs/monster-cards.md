...
| `monster_neutral_1_c` | nøytral | 1 | `1 stein, 1 blad` | 1 | `2 stein -> 1 styrke` | Ingen | Ingen | 2 |
| `monster_neutral_2_a` | nøytral | 2 | `2 stein` | 2 | `3 stein -> 1 styrke` | Ingen | Ingen | 3 |
| `monster_neutral_2_b` | nøytral | 2 | `2 stein, 1 valgfritt_element` | 1 | `3 stein -> 1 styrke` | `4 stein -> 1 styrke` | Ingen | 3 |
